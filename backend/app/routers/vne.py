...
def _models() -> List[VneModelConfig]:
    ...
    m2_sel_chiusure = _env("VNE_MODEL_2_SEL_CHIUSURE_URL", "http://vneremote.com/31/139/supervlt/sel_chiusure")
    m2_chiusure = _env("VNE_MODEL_2_CHIUSURE_URL", "http://vneremote.com/31/139/supervlt/chiusure/")
    m2_contabilita = _env("VNE_MODEL_2_CONTABILITA_URL", "")
    m2_ref = _env("VNE_MODEL_2_REFERER_URL", "http://vneremote.com/31/139/supervlt/?param=NO")
