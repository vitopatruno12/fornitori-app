...
def _ensure_staff_documents_table() -> None:
    """PDF contratti / buste / documenti personale (migr. 20260918_staff_documents.sql)."""
    try:
        with engine.begin() as conn:
            conn.execute(
                text(
        ...
        logger.warning("Impossibile verificare/creare staff_documents: %s", e)
