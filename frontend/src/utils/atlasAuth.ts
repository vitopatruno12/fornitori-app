...
const ATLAS_LOGIN_USER = (import.meta.env.VITE_ATLAS_LOGIN_USER || 'michele.giliberti').trim()
const ATLAS_LOGIN_PASSWORD = (import.meta.env.VITE_ATLAS_LOGIN_PASSWORD || 'michele.giliberti').trim()
